...
把 `inventory.json` 里所有 skill 的 description 全文摆进 context，按以下三个维度做 mental 分组。注意：主流 skill 市场远不止开发工具——办公协作、内容创作、金融投资、智能家居、生活服务等领域都有大量 skill，分组时要覆盖用户实际安装的所有领域，不要只看开发侧。

- **服务对象**（代码托管 / 云平台 / CI·CD / 数据库 / 办公协作 / 通讯与邮件 / 项目管理 / CRM / 设计工具 / 电商与支付 / 可观测性 / 社交媒体与内容平台 / 金融投资 / 文档与知识库 / 智能家居与IoT / 音视频与创意 / 教育学术 / 安全与合规 / 浏览器与网页 / 本地文件 / 生活服务 / ...）
- **主要功能**（代码生成 / 审查与检查 / 测试 / 部署 / 监控 / 搜索 / 同步与迁移 / 消息通知 / 文档处理 / 安全扫描 / 多 agent 编排 / 规划与设计 / 内容创作与营销 / 数据分析与可视化 / 视觉设计与生成 / 语音与转录 / 知识管理 / 工作流自动化 / ...）
- **触发场景**（用户在什么情景下会自然想到它：推上线 / 查 bug / 做代码审查 / 安全审计 / 写文档 / 调研竞品 / 看数据 / 管工单 / 发消息 / 搭页面 / 串流程 / 跑测试 / 写文案做运营 / 看行情分析财报 / 控制智能设备 / 查文献写论文 / 出设计稿 / 处理文件格式 / ...）
