...
Do not modify installed skills in version 1. Do not execute scripts from inspected skills. Plugin-managed and system-managed skills are read-only. If SkillTriage scans itself, mark it as self-scan and avoid archive, delete, or direct rewrite proposals.
